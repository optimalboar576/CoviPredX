# CoviPredX - Bioactivity Screening Tool (v1.1.0)
...
- **Accurate Predictions**: Built with cutting-edge machine learning algorithms like Stacking model (RF+XGB+LGBM), CoviPredX provides reliable pIC50 predictions.
